...
/**
 * Servlet implementation class m_religion
 */
public class m_religion extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			PreparedStatement pstmt=con.prepareStatement("update user_reg set Religion=? where Aadhar_Card_No=?");
