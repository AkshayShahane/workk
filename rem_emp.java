...
/**
 * Servlet implementation class rem_emp
 */
public class rem_emp extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			PreparedStatement pstmt=con.prepareStatement("Delete from emp where Username=?");
			...
			Statement stmt=con.createStatement();
	          //ResultSet rs=stmt.executeQuery("select * from user_reg");
	            ...
	            out.println("<font color='green'><h1><b><u>Record Deleted Successfull....</u></b></h1></font><br><br><br><br>");
