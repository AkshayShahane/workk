...
/**
 * Servlet implementation class m_lstatus
 */
public class m_lstatus extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String literacy=request.getParameter("lit");
		...
		try{
			...
			PreparedStatement pstmt=con.prepareStatement("update user_reg set Literacy_Status=? where Aadhar_Card_No=?");
			pstmt.setString(1,literacy);
