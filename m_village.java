...
/**
 * Servlet implementation class m_village
 */
public class m_village extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			PreparedStatement pstmt=con.prepareStatement("update user_reg set Village=? where Aadhar_Card_No=?");
