...
/**
 * Servlet implementation class m_age
 */
public class m_age extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			PreparedStatement pstmt=con.prepareStatement("update user_reg set Age=? where Aadhar_Card_No=?");
