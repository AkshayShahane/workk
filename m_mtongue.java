...
/**
 * Servlet implementation class m_mtongue
 */
public class m_mtongue extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String Mother_tongue=request.getParameter("m_t");
		...
		try{
			...
			PreparedStatement pstmt=con.prepareStatement("update user_reg set Mother_Tongue=? where Aadhar_Card_No=?");
			pstmt.setString(1,Mother_tongue);
